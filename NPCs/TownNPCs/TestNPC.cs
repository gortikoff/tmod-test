...
namespace BogdanMod.NPCs.TownNPCs
{
    ...
    {
        const string ShopName = "Pupochki";
        public override void SetStaticDefaults()
        {
            DisplayName.CanFormatWith("Tester");
        }
    ...
    */
        ...
        //    .Add(new Item(ModContent.ItemType<Zulfikar>));  
        }

        public override string GetChat()
        {
            NPC.FindFirstNPC(ModContent.NPCType<TestNPC>());
        ...
        {
            Item.NewItem(NPC.GetSource_Death(), NPC.getRect(), ModContent.ItemType<Zulfikar>(), 1, false, 0, false, false);
        }
    }
}
